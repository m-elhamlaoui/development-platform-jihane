...
if curl -s http://localhost:8090/api/health > /dev/null; then
    echo -e "${GREEN}✅ Backend API is accessible at http://localhost:8090${NC}"
    echo -e "${GREEN}✅ Registration endpoint: http://localhost:8090/api/signup${NC}"
    echo -e "${GREEN}✅ Login endpoint: http://localhost:8090/api/login${NC}"
else
...
echo -e "   🌐 Base URL: http://localhost:8090"
echo -e "   👤 Signup: POST http://localhost:8090/api/signup"
echo -e "   🔐 Login: POST http://localhost:8090/api/login"
echo -e "   📊 Health: GET http://localhost:8090/api/health"
echo -e "   🚀 Space Data: GET http://localhost:8090/api/space/*"
echo ""
echo -e "${YELLOW}🌐 FRONTEND:${NC}"
echo -e "   📱 Website: http://development-platform.local"
echo ""
echo -e "${BLUE}💡 INSTRUCTIONS:${NC}"
echo -e "   1. Your backend is now accessible at http://localhost:8090"
