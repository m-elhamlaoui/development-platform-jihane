  ...
  return (
    <div className="bg-gradient-to-r from-[#0F0320] to-[#0C0417] min-h-screen w-full">
      ...
      <div className="absolute mt-50 ml-180 w-110 h-150">
        <form
          className="p-8 border border-[#434141] w-96 pt-0 w-full h-full justify-center"
          onSubmit={handleRegister}
        >
          <h1 className="text-7xl text-white font-bold mt-5 ml-10">SIGN up</h1>
          <div className="w-full">

            <div className="h-15 mt-16 rounded-2xl bg-[#14022D] flex flex-row gap-2 text-[#DDD4D4]">
              <label className="pt-4 pl-4">
                <svg
            ...
            <div className="flex flex-row gap-28 w-full h-15 mt-8 text-white bg-[#14022D] p-3 rounded-2xl">
              <div className="flex flex-row gap-2">
                <label className="pt-1 pl-1">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    height="24px"
                    viewBox="0 -960 960 960"
            ...
            <button
              ...
              className="w-full p-3 h-15 text-white text-[20px] font-bold rounded-2xl bg-gradient-to-r from-[#492871] to-[#113B65]"
            >
              Sign up
            </button>
